...
Jika proses migrasi gagal, silakan import manual file database dengan nama nmovie.sql yang berada di folder db
...
Untuk mengkses aplikasi pastikan aplikasi sudah berjalan atau jika belum maka jalankan aplikasi terlebih dahulu menggunakan perintah dibawah
